...
$total_count = wp_count_posts('plugin');
?>
    ...
    <div class="entry-content">
        <div class="row">
            ...
            <div class="col">
                <?php
                if (get_field('at_org')) {
                    echo '<a href="https://tw.wordpress.org/plugins/' . get_post_field('post_name', get_the_ID()) . '/" rel="external nofollow noopener" target="_blank">WordPress.org 網頁</a>';
                } else {
                    echo '否';
                }
                ?>
